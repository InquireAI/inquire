...
from telegram.ext import Application, CallbackQueryHandler, CommandHandler, ContextTypes, AIORateLimiter, MessageHandler, filters, InlineQueryHandler, ChatMemberHandler, TypeHandler, CallbackContext, ExtBot
...
""")
    ...
    async def error_handler(self, update: Update, context: CustomContext) -> None:
        """
